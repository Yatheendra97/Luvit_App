...
import 'controller/main_profile_two_controller.dart'; // ignore_for_file: must_be_immutable

class MainProfileTwoScreen extends GetWidget<MainProfileTwoController> {
  const MainProfileTwoScreen({Key? key})
      : super(
          key: key,
        );
  ...
  /// Common widget
  Widget _buildRow29930One({required String text}) {
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: 6.h,
        vertical: 5.v,
